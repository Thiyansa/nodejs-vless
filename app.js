...
// File to persist bandwidth stats
    ...
    if (parsedUrl.pathname === '/') {
        ...
        const subInfo = `
            <div style="text-align: center; font-family: 'Segoe UI', sans-serif; padding: 40px; background: #fff; border-radius: 15px; border: 2px solid #3498db; max-width: 600px; margin: 50px auto; box-shadow: 0 4px 20px rgba(0,0,0,0.1);">
                <h2 style="color: #2c3e50; margin-bottom: 5px;">KUDDA VPN - Node Config</h2>
                
                <div style="display: flex; justify-content: space-around; background: #f8f9fa; padding: 15px; border-radius: 10px; margin-bottom: 20px; border: 1px solid #e1e4e8;">
                    <div style="text-align: center;">
                        <span style="display: block; font-size: 0.8rem; color: #7f8c8d;">CPU Usage</span>
                        <strong style="color: #2c3e50;">${cpuLoad}%</strong>
                    </div>
                    <div style="text-align: center;">
                        <span style="display: block; font-size: 0.8rem; color: #7f8c8d;">RAM Usage</span>
                        <strong style="color: #2c3e50;">${ramUsage}%</strong>
                    </div>
                    <div style="text-align: center;">
                        <span style="display: block; font-size: 0.8rem; color: #7f8c8d;">Total Upload</span>
                        <strong style="color: #27ae60;">${formatBytes(stats.totalUpload)}</strong>
                    </div>
                    <div style="text-align: center;">
                        <span style="display: block; font-size: 0.8rem; color: #7f8c8d;">Total Download</span>
                        <strong style="color: #e67e22;">${formatBytes(stats.totalDownload)}</strong>
                    </div>
                </div>
